...
def yes_no(question):
    """Checks that users enter yes or no"""
...
def get_expenses(exp_type, how_many=1):
    """Gets variable / fixed expenses and output panda (as a string) and a subtotal of the expenses"""
...
target = profit_goal(input(total_expenses))
